...
export class OpenerComponent implements OnInit {
    ...
    nextBtn(path) {
        ga('send', { hitType: 'event', eventCategory: 'Openers', eventAction: 'NextStep-F&I-GDO', eventLabel: 'nextBtn' });
    ...
    accessoriesModalNext() {
        ga('send', { hitType: 'event', eventCategory: 'Openers', eventAction: 'NextStep-F&I-GDOAccessories', eventLabel: 'accessoriesModalNext' });
        $('body').addClass('loader');
