...
const ENG =
    {
        ...
        "doorSize": [{
            ...
            "floridaPopup": {
                "modalHeader": "",
                "modalContent": "You live in a high-wind are and are required to add 2' to the width pf your door <strong> if your opening exceeds 9'2' wide. </strong>When entering width you MUST use the following formula (door width = opening width + 2').",
